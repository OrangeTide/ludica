...
# cliptest and dndtest drive a raw-Xlib second client, so they only build
# where X11 exists. Excludes the Emscripten and Windows targets.
ifeq ($(_TARGET_OS),Linux)
SUBDIRS += cliptest dndtest
endif
