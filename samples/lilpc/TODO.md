...
- [x] ATI Graphics Solution rev3. a CGA+MDA+Hercules+Plantronics superset on one card (CW16800-A, 64KB, UM6845E). see [doc/notes/ati-graphics-solution.md](/doc/notes/ati-graphics-solution.md) for full register map.
  - [x] level 1: Plantronics ColorPlus. port 0x3DD bits 4-6, extend VRAM to 32KB, dual-plane 320x200x16 and 640x200x4.
  - [x] level 2: ATI 640x200x16 (port 0x3DD bit 7), 132-column text (port 0x3DF), extend VRAM to 64KB with 4-bank interlace.
  - [x] level 3: unified CGA/MDA/HGC card with mono-side ports (0x3Bx) and software mode switching.
