...
lilpc_SRCS  = lilpc.c cpu286.c bus.c chipset.c video.c kbd.c fdc.c serial.c parallel.c speaker.c debugmon.c hostfs.c
lilpc_LIBS = ludica
...
# build HOSTFS.COM guest TSR (requires nasm)
$(lilpc_DIR)hostfs_init.com: $(lilpc_DIR)hostfs_init.asm
	nasm -f bin -o $@ $<
