...
ludica_SRCS  = app.c args.c config.c event.c timing.c log.c input.c action.c gamepad.c shader.c mesh.c renderstate.c rendertarget.c texture.c framebuffer.c image.c sprite.c font.c slug.c msdf.c vfont.c progress.c anim.c audio.c automation.c
