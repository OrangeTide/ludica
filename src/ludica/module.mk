...
ludica_SRCS  = app.c args.c config.c event.c timing.c log.c input.c action.c gamepad.c shader.c mesh.c texture.c framebuffer.c image.c sprite.c font.c slug.c progress.c anim.c audio.c automation.c
ludica_GENERATED_SRCS = shaders/framebuffer.c shaders/sprite.c shaders/slug.c
