...
ludica_SRCS  = app.c args.c config.c event.c timing.c log.c input.c action.c gamepad.c arena.c deferred.c shader.c mesh.c renderstate.c rendertarget.c texture.c framebuffer.c image.c sprite.c font.c slug.c msdf.c vfont.c progress.c anim.c audio.c automation.c
ludica_GENERATED_SRCS = shaders/framebuffer.c shaders/sprite.c shaders/slug.c shaders/msdf.c
...
ludica_SRCS.Windows_NT = platform_win32.c win32/clipboard.c win32/dragdrop.c win32/gamepad-windows.c
...
ludica_EXPORTED_LDLIBS.Windows_NT = -lgdi32 -lwinmm -lEGL -lGLESv2 -lXinput -lws2_32 -lole32 -luuid
...
ludica_EXPORTED_LDLIBS.Emscripten = -sFULL_ES2=1 -sFULL_ES3=1 -sUSE_WEBGL2=1 -sALLOW_MEMORY_GROWTH=1 -sEXPORTED_RUNTIME_METHODS=ccall
