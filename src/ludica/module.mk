...
ludica_SRCS  = app.c args.c lud_getopt.c event.c timing.c log.c input.c action.c gamepad.c shader.c mesh.c texture.c framebuffer.c image.c sprite.c font.c progress.c anim.c audio.c automation.c
